...
const defaults = (workspaces: Workspace[], accounts: Account[]): DefaultValues<MovementFormValues> => ({ workspace_id: workspaces[0]?.id, type: "expense", currency: "ARS", date: getLocalIsoDate(), account_id: accounts[0]?.id, transfer_account_id: null, category_id: null, description: "" });
