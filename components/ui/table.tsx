...
export const TableRow = ({ className, ...props }: React.HTMLAttributes<HTMLTableRowElement>) => <tr className={cn("border-b transition-colors duration-200 hover:bg-[var(--card-header)]", className)} {...props} />;
